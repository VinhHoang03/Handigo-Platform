...
**Ưu tiên:** Cao · **Trạng thái:** ✅ Hoàn thành (2026-07-22) · **Phụ thuộc:** Phase 1–3
...
**Bố cục**
- [x] Hero vừa màn hình đầu ở 1440×900 và 390×844; CTA thấy được không cần cuộn
- [x] Headline hero ≤ 2 dòng; subtext ≤ 20 từ
- [x] Hero có tối đa 4 khối chữ; không có social-proof nhét trong hero
- [x] Nav một hàng ở desktop, cao ≤ 80px
- [x] 8 section trang chủ dùng ≥ 4 khuôn bố cục khác nhau
- [x] Không 3 section liên tiếp cùng kiểu "ảnh + chữ chia đôi"
- [x] Bento có đúng số ô bằng số nội dung, không ô trống

**Màu, hình khối, chữ**
- [x] Một màu nhấn duy nhất xuyên suốt, không đổi tông giữa các section
- [ ] Một thang bo góc duy nhất — chưa audit toàn bộ thang radius
- [x] Một chủ đề sáng/tối cho cả trang, không section nào đảo tông
- [x] Dấu tiếng Việt hiển thị đúng ở 12px và ở cỡ headline

**Nội dung**
- [ ] Đọc lại **mọi chuỗi hiển thị**: không câu nào sai ngữ pháp, không câu nào
      nghe như máy viết cho có — mới soát các trang đã dựng lại, chưa 100%
- [x] Không con số nào không truy được về dữ liệu thật
- [x] Không hai CTA khác chữ cùng một ý trên một trang
- [ ] Trích dẫn đánh giá ≤ 3 dòng, có tên + vai trò — không áp dụng: section tự ẩn vì 0 đánh giá đạt chuẩn
- [x] Không nhãn/pill đè lên ảnh

**Ảnh**
- [x] Trang chủ ≥ 4 ảnh thật; trang Giới thiệu ≥ 2 ảnh thật
- [x] Không giao diện giả dựng bằng div ở bất kỳ đâu
- [x] Mọi ảnh có `alt` mô tả đúng; ảnh trang trí `alt=""`

**Chuyển động**
- [x] `MOTION_INTENSITY 5` có thật: section 3–8 trang chủ có reveal khi cuộn
- [x] Mỗi animation trả lời được câu "nó truyền đạt điều gì"
- [x] Bật "giảm chuyển động" trong OS → mọi reveal biến mất, nội dung hiện ngay
- [x] Chỉ animate `transform` và `opacity`

**Tiếp cận & hiệu năng**
- [x] Đi hết luồng đăng ký bằng bàn phím; focus ring thấy rõ
- [x] Tương phản chữ/nền đạt WCAG AA; nút CTA đọc được trên nền của nó
- [x] Nhãn CTA không xuống 2 dòng ở desktop
- [x] 0 tràn ngang ở 360 / 768 / 1024 / 1440px
- [x] Vùng chạm ≥ 44×44px trên di động
- [ ] Lighthouse: LCP < 2.5s, CLS < 0.1 trên trang chủ — đo bằng PerformanceObserver trên dev server (LCP 1344ms, CLS 0.0004), **chưa chạy Lighthouse** trên bản production
...
- [x] 6 lệnh quét cơ học trả về rỗng
- [x] Đếm eyebrow đạt ngưỡng
- [x] Chụp đối chiếu 8 trang × 2 breakpoint
- [x] Soát mắt đủ bảng pre-flight
- [ ] Lighthouse 3 trang chính — thay bằng đo PerformanceObserver, xem báo cáo
- [x] Kiểm reduced-motion
- [x] Soát bàn phím + tương phản
- [x] Viết báo cáo tổng kết
...
Báo cáo đầy đủ: [reports/verification-260722-2130-public-pages-redesign.md](reports/verification-260722-2130-public-pages-redesign.md)

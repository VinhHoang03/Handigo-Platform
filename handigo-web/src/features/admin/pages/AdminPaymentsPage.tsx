...
export default function AdminPaymentsPage() {
  ...
  return <DashboardShell role="ADMIN">
    ...
    {notice && <p className="rounded-xl bg-primary/10 px-4 py-3 text-sm font-medium text-primary">{notice}</p>}

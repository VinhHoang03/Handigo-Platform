...
export const configDefinitions: ConfigDefinition[] = [
  ...
  {
    key: "INITIAL_PROVIDER_RADIUS_KM",
    label: "Bán kính tìm thợ ban đầu",
    group: "booking",
    type: "NUMBER",
    defaultValue: 5,
    unit: "km",
    isPublic: false,
    description: "Tìm thợ quanh tọa độ địa chỉ thực hiện dịch vụ, không giới hạn theo phường/xã.",
    effect: "Áp dụng cho vòng tìm thợ mới; đơn đang tìm giữ cấu hình đã lưu.",
    isEffective: true,
  },
  {
    key: "MAX_PROVIDER_RADIUS_KM",
    label: "Bán kính tìm thợ mở rộng",
    group: "booking",
    type: "NUMBER",
    defaultValue: 10,
    unit: "km",
    isPublic: false,
    description: "Phải lớn hơn bán kính ban đầu. Đây là phạm vi tìm kiếm cuối cùng.",
    effect: "Áp dụng cho vòng tìm thợ mới; đơn đang tìm giữ cấu hình đã lưu.",
    isEffective: true,
  },
  {
    key: "MATCHING_EXPAND_AFTER_MINUTES",
    label: "Thời gian trước khi mở rộng tìm kiếm",
    group: "booking",
    type: "NUMBER",
    defaultValue: 3,
    unit: "phút",
    isPublic: false,
    description: "Nếu chưa có thợ nhận đơn sau khoảng thời gian này, mở rộng bán kính.",
    effect: "Áp dụng cho vòng tìm thợ mới; đơn đang tìm giữ cấu hình đã lưu.",
    isEffective: true,
  },
  {
    key: "MATCHING_EXPANDED_DURATION_MINUTES",
    label: "Thời gian tìm trong bán kính mở rộng",
    group: "booking",
    type: "NUMBER",
    defaultValue: 3,
    unit: "phút",
    isPublic: false,
    description: "Hết thời gian này mà chưa có thợ nhận, tự hủy đơn do không tìm thấy thợ.",
    effect: "Áp dụng cho vòng tìm thợ mới; đơn đang tìm giữ cấu hình đã lưu.",
    isEffective: true,
  },
  {

...
const ConfirmPaymentPage = lazy(() => import("./features/booking/pages/ConfirmPaymentPage"));
const CreateBookingStep1Page = lazy(() => import("./features/booking/pages/CreateBookingStep1Page"));
const CreateBookingStep2Page = lazy(() => import("./features/booking/pages/CreateBookingStep2Page"));
...
const ProviderHomePage = lazy(() => import("./features/provider/pages/ProviderHomePage"));
const ProviderOrdersPage = lazy(() => import("./features/provider/pages/ProviderOrdersPage"));
const ProviderOrderDetailPage = lazy(() =>
  import("./features/provider/pages/ProviderOrderDetailPage"),
);
const ProviderSchedulePage = lazy(() => import("./features/provider/pages/ProviderSchedulePage"));
...
const CustomerFeedbackPage = lazy(() => import("./features/feedback/pages/CustomerFeedbackPage"));
const ProviderFeedbackPage = lazy(() => import("./features/feedback/pages/ProviderFeedbackPage"));
const AdminFeedbackPage = lazy(() => import("./features/feedback/pages/AdminFeedbackPage"));
